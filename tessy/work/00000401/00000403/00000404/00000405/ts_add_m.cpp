 ...
 *
 *
 * File          : Master Source (ts_add_m.cpp)
...
#define TS_ROOT_FOLDER      "C:/Users/Sowjanya/Projects/TESSY/STUB_E~1/tessy"
#define TS_PROJECT_ID        1024
#define TS_MODULE_ID         1028
#define TS_TESTOBJECT_ID     1029
#define TS_TESTOBJECT_IDB_ID 3

#define TS_MODULE     "New Module"
#define TS_TESTPATH "C:/Users/Sowjanya/Projects/TESSY/STUB_E~1/tessy\\work\\00000401\\00000403\\00000404\\00000405"
#define TS_TESTOBJECT "add"
...
void ts_send_TD(void) {
   ...
   /* Globals */
   ifobject = ts_master.getIFObject(2, 5);
   ...
   ts_send_value(ifobject, 0);
   ifobject = ts_master.getIFObject(2, 7);
...
static void ts_receive_AD(void)
{
   ...
   /* Return */
   ifobject = ts_master.getIFObject(16, 4);
...
int main(int argc, char* argv[])
{
   ...
   if (argc > 1 && 0 == strcmp(argv[1], "-break")) {
      _TessyEnvironment[3] = strdup("add");
   }
